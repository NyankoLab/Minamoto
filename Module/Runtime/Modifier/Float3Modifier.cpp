...
//------------------------------------------------------------------------------
void Float3Modifier::Assign(void* source, float time)
{
    Set(*(xxVector3*)source);
}
//------------------------------------------------------------------------------
void Float3Modifier::Update(void* target, float time, xxModifierData* data)
{
    *(xxVector3*)target = Get();
}
//------------------------------------------------------------------------------
