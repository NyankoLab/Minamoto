...
#pragma comment(linker, "/alternatename:__imp_?Traversal@xxNode@@SA_NAEBV?$shared_ptr@UNode@@@std@@V?$function@$$A6A_NAEBV?$shared_ptr@UNode@@@std@@@Z@34@@Z=__imp_?Traversal@xxNode@@SA_NAEBV?$shared_ptr@VxxNode@@@std@@V?$function@$$A6A_NAEBV?$shared_ptr@VxxNode@@@std@@@Z@34@@Z")
...
#pragma comment(linker, "/alternatename:?Traversal@xxNode@@SA_NAEBV?$shared_ptr@UNode@@@std@@V?$function@$$A6A_NAEBV?$shared_ptr@UNode@@@std@@@Z@3@@Z=?Traversal@xxNode@@SA_NAEBV?$shared_ptr@VxxNode@@@std@@V?$function@$$A6A_NAEBV?$shared_ptr@VxxNode@@@std@@@Z@3@@Z")
